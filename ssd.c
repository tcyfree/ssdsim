...
void statistic_output(struct ssd_info *ssd)
{
	...
	fprintf(ssd->outputfile,"%2d, %13d, %13d, %13d, %13lld, %13lld\n", ssd->seq_num, ssd->gc_count, ssd->gc_lpn_count, ssd->gc_seq_lpn_count, ssd->read_avg/ssd->read_request_count, ssd->write_avg/ssd->write_request_count);
	fflush(ssd->outputfile);
